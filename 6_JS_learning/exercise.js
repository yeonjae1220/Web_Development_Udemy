...
let courseName = "Web Development - The Coxmplete Guide";
let price = 39;
let goals = ["Learn Web Development", "Become a web developer", "Have fun!"];

alert(courseName);
alert(price);
alert(goals);
let onlineCourse = {
  name: "Web Development - The Coxmplete Guide",
  price: 39,
